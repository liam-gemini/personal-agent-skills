...
- Keep reusable source notes with their owning Skill under `references/`; use `knowledge-base/` for attributed indexes across Skills rather than duplicating source material.
